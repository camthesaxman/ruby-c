int __fastcall sub_80FD68C(_WORD *a1, _WORD *a2, _WORD *a3)
{
  _WORD *v3; // r3@1
  _WORD *v4; // r10@1
  int v5; // r1@1
  ...
  if ( v5 != *v4 || *a3 != v5 )
  {
    ...
    if ( v10 != v11 || v12 != v11 )
    {
      ...
      if ( v14 >= (unsigned __int16)v15 )
        v15 = v14;
      result = ((signed int)(v8 * ((31 - (v15 >> 1)) & 0xFFFF)) / 31 & 0xFFFF | ((signed int)(v16
                                                                                            * ((31 - (v15 >> 1)) & 0xFFFF))
                                                                               / 31 << 10) & 0x3FFFFFF | 32 * ((signed int)(v9 * ((31 - (v15 >> 1)) & 0xFFFF)) / 31 & 0xFFFF)) & 0xFFFF;
    }
    else
    {
      result = *v4;
