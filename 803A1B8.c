int sub_803A1B8()
{
  ...
  *((_WORD *)v0 + 27) = *((_WORD *)v0 + 17);
  ...
  oamt_set_x3A_32(&gSprites[68 * *(_BYTE *)(v2024A60 + 0x2024BE0)], sub_803A3A8);
  LOWORD(dword_3004B20[10 * (unsigned __int8)CreateTask(sub_803A2C4, 5) + 2]) = v2024A60;
  if ( *(_BYTE *)(12 * v2024A60 + 0x2017810) & 1 )
    dword_3004B20[10 * *(_BYTE *)(v2024A60 + 0x2024E68)] = (int)sub_8044CA0;
  v2017849 |= 1u;
  dword_3004330[v2024A60] = (int)nullsub_47;
  return v2;
}
