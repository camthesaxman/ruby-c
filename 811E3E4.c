int dp01t_00_3_getattr()
{
  ...
  if ( *(_BYTE *)((v2024A60 << 9) + 0x2023A62) )
  {
    ...
    {
      if ( v1 & 1 )
        v0 += dp01_getattr_by_ch1_for_player_pokemon((unsigned __int8)v2, (char *)&v4 + v0);
      v1 >>= 1;
      ++v2;
    }
    while ( v2 <= 5 );
  ...
  {
    LOWORD(v0) = dp01_getattr_by_ch1_for_player_pokemon(*(_BYTE *)(2 * v2024A60 + 0x2024A6A), &v4);
  }
