int __fastcall DrawGlyphTile_ShadowedFont(int a1)
{
  int v1; // r7@1
  int v2; // r5@1
  _DWORD *v3; // r2@1
  ...
  v7 = (int)*(&sShiftGlyphTileShadowedFuncs + *(_BYTE *)(v1 + 2));
  call_via_r4(&sGlyphBuffer, *(_DWORD *)(v1 + 4), *(_DWORD *)(v1 + 12), *(_BYTE *)(v1 + 1));
