int __fastcall sub_802F934(unsigned __int8 a1, unsigned __int8 a2)
{
  int v2; // r6@1
  int v3; // r8@1
  _BYTE *v4; // r9@1
  ...
  *(_WORD *)(2 * v2 + 0x2024A6A) = *(_BYTE *)((v2 << 9) + 0x2023A61);
  v3 = (unsigned __int16)GetMonData((char *)&unk_3004360 + 100 * *(_WORD *)(2 * v2 + 0x2024A6A), 11);
  v4 = &byte_300434C[v2];
  ...
  *(_WORD *)&gSprites[68 * *v4 + 46] = (unsigned __int8)sub_8046400(0, 255);
  return v11;
}
