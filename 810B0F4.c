int __fastcall sub_810B0F4(int a1)
{
  int v1; // r6@1
  int v2; // r1@1
  int v3; // r4@1
  ...
  v1 = a1;
  v2 = *(_WORD *)(a1 + 46);
  v3 = HIWORD(dword_3004B20[10 * v2 + 2]);
  v4 = HIWORD(dword_3004B20[10 * v2 + 2]);
  v5 = (signed __int16)sine2(HIWORD(dword_3004B20[10 * v2 + 2]));
  ...
  if ( (v7 & 0x8000u) != 0 )
    v7 += 15;
  SetOamMatrix(1, v7 >> 4, v6, -(signed __int16)v6, v7 >> 4);
