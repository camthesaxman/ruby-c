int sub_8030698()
{
  ...
  if ( (signed __int16)(*(_BYTE *)((v2024A60 << 9) + 0x2023A62) | (unsigned __int16)(*(_BYTE *)((v2024A60 << 9)
                                                                                              + 0x2023A63) << 8)) == 0x7FFF )
  {
    v2 = GetMonData((char *)&unk_3004360 + 100 * *(_WORD *)(2 * v2024A60 + 0x2024A6A), 58);
    sub_8043D84(v2024A60, (unsigned __int8)byte_3004340[v2024A60], v2, 0);
    sub_80440EC((unsigned __int8)byte_3004340[v2024A60]);
  }
  else
  {
    v0 = GetMonData((char *)&unk_3004360 + 100 * *(_WORD *)(2 * v2024A60 + 0x2024A6A), 58);
    v1 = GetMonData((char *)&unk_3004360 + 100 * *(_WORD *)(2 * v2024A60 + 0x2024A6A), 57);
    sub_8043D84(v2024A60, (unsigned __int8)byte_3004340[v2024A60], v0, v1);
  }
  dword_3004330[v2024A60] = (int)bx_t1_healthbar_update;
  return v4;
}
