int __fastcall sub_806D668(int a1)
{
  int v1; // r5@1
  int v2; // r0@1
  ...
  v3 = *(&gUnknown_08376978[24 * v2] + 4 * v1);
  v4 = (unsigned __int8)battle_type_is_double(v2);
  v5 = *(&gUnknown_08376978[24 * v4 + 1] + 4 * v1);
  v6 = (unsigned __int8)battle_type_is_double(v4);
  v7 = *(&gUnknown_08376978[24 * v6 + 2] + 4 * v1);
  v8 = battle_type_is_double(v6);
  ZeroFillWindowRect((int)&unk_3004210, v3, v5, v7, *(&gUnknown_08376978[24 * v8 + 3] + 4 * v1));
  v10 = 0;
  CpuFastSet(&v10, (v1 << 10) + 100745984, 16777280);
  return v11;
}
