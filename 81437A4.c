int __fastcall sub_81437A4(signed int a1, __int16 a2, __int16 a3, __int16 a4)
{
  __int16 v4; // r9@1
  __int16 v5; // r10@1
  __int16 v6; // r6@1
  ...
  DecompressPicFromTable_2(
    ...
    gTrainerFrontPicCoords[4 * a1],
    gTrainerFrontPicCoords[4 * a1 + 1],
    0x2000000,
    gUnknown_0840B5A0[(unsigned __int16)a4],
    a1);
  LoadCompressedPalette(*(_DWORD *)&gTrainerFrontPicPaletteTable[v7], 16 * v6 + 256, 32);
